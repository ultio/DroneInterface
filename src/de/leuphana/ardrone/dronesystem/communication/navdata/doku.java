...
public class doku {
	...
	// * a 'multiple definition' compilation error. This is a GCC specific
	// feature.
	// **/
	...
	// * This is the main method that SDK users should use to change a setting
	// on
	// * the drone.
	...
	// * **/
	// //Deprecated - no ack method - #define ARDRONE_CONFIGURATION_SET(NAME,
	// VALUE) ARDRONE_CONFIGURATION_SET_FUNCTION(NAME)(VALUE)
	// #define ARDRONE_CONFIGURATION_SET_FUNCTION(NAME)
	// ardrone_at_configuration_set_##NAME
	// #define ARDRONE_CONFIGURATION_PROTOTYPE(C_TYPE, NAME) C_RESULT
	// ARDRONE_CONFIGURATION_SET_FUNCTION(NAME)(C_TYPE NAME)
	//
	// /**
	...
	// * SDK users should not deal with this; see ARDRONE_CONFIGURATION_SET to
	// change
	// * a drone setting.
	// */
	// typedef union
	...
	//
	// typedef C_RESULT
	// (*ardrone_at_configuration_set)(ardrone_configuration_value_t value);
	//
	// /**
	...
	// ARDRONE_UPDATE_CONTROL_MODE, /*<! Deprecated - Ardrone software update
	// reception (update is done next run) */
	// /*<! After event completion, card should power off */
	// PIC_UPDATE_CONTROL_MODE, /*<! Ardrone PIC software update reception
	// (update is done next run) */
	// /*<! After event completion, card should power off */
	...
	// ZAP_CHANNEL_LARGE_HORI_SMALL_VERT, /*<! Selects the horizontal camera
	// with vertical camera picture inserted in the left-top corner */
	// ZAP_CHANNEL_LARGE_VERT_SMALL_HORI, /*<! Selects the vertical camera with
	// horizontal camera picture inserted in the left-top corner */
	// ZAP_CHANNEL_LAST = ZAP_CHANNEL_LARGE_VERT_SMALL_HORI, /*<! Last element
	// */
	// ZAP_CHANNEL_NEXT, /*<! Selects the next available format among those
	// above. */
	// } ZAP_VIDEO_CHANNEL;
	//
	// /**
	...
	// CAD_TYPE_ORIENTED_COCARDE, /*<! Detects an oriented roundel under the
	// drone */
	// CAD_TYPE_STRIPE, /*<! Detects a uniform stripe on the ground */
	// CAD_TYPE_H_COCARDE, /*<! Detects a roundel in front of the drone */
	// CAD_TYPE_H_ORIENTED_COCARDE, /*<! Detects an oriented roundel in front of
	// the drone */
	// CAD_TYPE_STRIPE_V,
	// CAD_TYPE_MULTIPLE_DETECTION_MODE, /* The drone uses several detections at
	// the same time */
	// CAD_TYPE_NUM, /*<! Number of possible values for CAD_TYPE */
	// } CAD_TYPE;
	//
	// /* Type of tag to detect
	// * This enum deprecates 'CAD_TYPE' which did not allow to mix tag types
	// and cameras */
	// typedef enum
	// {
	// TAG_TYPE_NONE = 0,
	...
	// typedef enum
	// {
	// DETECTION_SOURCE_CAMERA_HORIZONTAL=0, /*<! Tag was detected on the front
	// camera picture */
	// DETECTION_SOURCE_CAMERA_VERTICAL, /*<! Tag was detected on the vertical
	// camera picture at full speed */
	// DETECTION_SOURCE_CAMERA_VERTICAL_HSYNC, /*<! Tag was detected on the
	// vertical camera picture inside the horizontal pipeline */
	...
	// typedef enum
	// {
	// ARDRONE_DETECTION_COLOR_ORANGE_GREEN = 1, /*!< Cameras detect
	// orange-green-orange tags */
	// ARDRONE_DETECTION_COLOR_ORANGE_YELLOW, /*!< Cameras detect
	// orange-yellow-orange tags*/
	// ARDRONE_DETECTION_COLOR_ORANGE_BLUE /*!< Cameras detect
	// orange-blue-orange tags */
	// } COLORS_DETECTION_TYPE, ENEMY_COLORS_TYPE;
	//
	// /**
	// * @brief User-control mode setting in FreeFlight.
	// * @description Bit mask showing how a user of the FreeFlight app.
	// controls their drone.
	// */
	// typedef enum
	// {
	// // This is a bit to shift
	// // CONTROL_LEVEL_NOT_USED = 0,
	// CONTROL_LEVEL_COMBINED_YAW = 1, /*!< =1 : drone tilts sideward and turns
	// simultaneously */
	...
	// * @brief Deprecated - used internally by the drone - Vision params in
	// float32_t
	// */
	...
	// * @brief Used by Parrot only - drone externally-measured position in
	// 3D-space
	// */
	...
	// {
	// int32_t pq_kp; /**< Gain for proportional correction in pitch (p) and
	// roll (q) angular rate control */
	// int32_t r_kp; /**< Gain for proportional correction in yaw (r) angular
	// rate control */
	// int32_t r_ki; /**< Gain for integral correction in yaw (r) angular rate
	// control */
	// int32_t ea_kp; /**< Gain for proportional correction in Euler angle
	// control */
	...
	// int32_t hovering_kp; /**< Gain for proportional correction in hovering
	// control */
	// int32_t hovering_ki; /**< Gain for integral correction in hovering
	// control */
	// } api_control_gains_t;
	//
	// /**
	...
	// {
	// int32_t coarse_scale; /**< scale of current picture with respect to
	// original picture */
	// int32_t nb_pair; /**< number of searched pairs in each direction */
	// int32_t loss_per; /**< authorized lost pairs percentage for tracking */
	// int32_t nb_tracker_width; /**< number of trackers in width of current
	// picture */
	// int32_t nb_tracker_height; /**< number of trackers in height of current
	// picture */
	// int32_t scale; /**< distance between two pixels in a pair */
	// int32_t trans_max; /**< largest value of trackers translation between two
	// adjacent pictures */
	// int32_t max_pair_dist; /**< largest distance of pairs research from
	// tracker location */
	...
	// FLYING_MODE_HOVER_ON_TOP_OF_ROUNDEL, /**< Commands are disabled, drones
	// hovers on top of a roundel - roundel detection MUST be activated by the
	// user with 'detect_type' configuration. */
	// FLYING_MODE_NUM
	// } FLYING_MODE;
	//
	// /********************************************************************
	...
	// uint32_t last_navdata_refresh; /*! mask showing which block was refreshed
	// when receiving navdata */
	//
	...
	// * @brief Add an 'option' to the navdata network packet to be sent to a
	// client.
	// * Used by the drone 'navdata' thread.
	// */
	// #define ardrone_navdata_pack( navdata_ptr, option ) (navdata_option_t*)
	// navdata_pack_option( (uint8_t*) navdata_ptr, \
	// (uint8_t*) &option, \
	// option.size )
	//
	// /**
	// * @def ardrone_navdata_unpack
	// * @brief Extract an'option' from the navdata network packet sent by the
	// drone.
	// * Used by the client 'navdata' thread inside ARDroneTool.
	// */
	// #define ardrone_navdata_unpack( navdata_ptr, option ) (navdata_option_t*)
	// navdata_unpack_option( (uint8_t*) navdata_ptr, \
	// (uint8_t*) &option, \
	// navdata_ptr->size )
	//
	// /**
	...
	// client.
	// * Used by the drone 'navdata' thread.
	// * @param navdata_ptr Pointer to the buffer containing packed navdata to
	// be sent.
	// */
	// static INLINE uint8_t* navdata_pack_option( uint8_t* navdata_ptr,
	...
	// * Used by the client 'navdata' thread inside ARDroneTool.
	// */
	// static INLINE uint8_t* navdata_unpack_option( uint8_t* navdata_ptr,
	// uint8_t* data, uint32_t size )
	// {
	...
	// * Used by the client 'navdata' thread inside ARDroneTool.
	// */
	// static INLINE navdata_option_t* navdata_next_option( navdata_option_t*
	// navdata_options_ptr )
	// {
	// uint8_t* ptr;
	//
	...
	// * @param size Size of data calculate as follow :
	...
	// * @brief Disassembles a buffer of received navdata, and dispatches it
	// inside 'navdata_unpacked' structure.
	// */
	...
	// * @brief Jumps to a specified 'option' (block of navdata) inside a
	// navdata packed buffer.
	// */
	// navdata_option_t* ardrone_navdata_search_option( navdata_option_t*
	// navdata_options_ptr, navdata_tag_t tag ) API_WEAK;
	//
	// /********************************************************************
	// * AT FUNCTIONS
	// ********************************************************************/
	...
	// */
	// void ardrone_at_init_with_funcs ( const char* ip, size_t ip_len,
	// AT_CODEC_FUNCTIONS_PTRS *funcs) API_WEAK;
	//
	// /**
	// * @fn ardrone_at_open
	...
	// * @return void
	// * This should not be used by SDK users. Parameters value do not have any
	// fixed meaning.
	// */
	// void ardrone_at_set_ui_misc( int32_t m1, int32_t m2, int32_t m3, int32_t
	// m4 ) API_WEAK;
	//
	// /**
	...
	// */
	// void ardrone_at_set_manual_trims( float32_t trim_pitch, float32_t
	// trim_roll, float32_t trim_yaw ) API_WEAK;
	//
	// /**
	// * @brief Changes PID gains of the drone control loop
	// * @param user_ctrl_gains gains to be set
	// */
	// void ardrone_at_set_control_gains( api_control_gains_t* user_ctrl_gains )
	// API_WEAK;
	//
	// /**
	...
	// */
	// void ardrone_at_set_vision_track_params( api_vision_tracker_params_t*
	// params ) API_WEAK;
	//
	// /**
	...
	// */
	// void ardrone_at_set_led_animation ( LED_ANIMATION_IDS anim_id, float32_t
	// freq, uint32_t duration_sec ) API_WEAK;
	//
	// /**
	...
	//
	// /**
	// * @brief Used internally at Parrot - sets the drones position as seen by
	// polaris
	...
	// */
	// void ardrone_at_set_polaris_pos( float32_t x_polaris, float32_t
	// y_polaris, float32_t psi_polaris, bool_t defined, int32_t time_us )
	// API_WEAK;
	//
	// /**
	...
	// */
	// void ardrone_at_set_toy_configuration( const char* param, const char*
	// value ) API_WEAK;
	//
	// /**
	...
	// */
	// void ardrone_at_update_control_mode( uint32_t what_to_do, uint32_t
	// filesize ) API_WEAK;
	//
	// /**
	...
	// * @param flag Use 1 << value of ARDRONE_PROGRESSIVE_CMD_FLAG_XXX to use a
	// flag
	// * @param phi Left/right angle between -1 to +1 - negative values bend
	// leftward.
	// * @param roll Front/back angle between -1 to +1 - negative values bend
	// forward.
	...
	// * This function allows the client program to control the drone by giving
	// it a front/back
	// * and left/right bending order, a vertical speed order, and a rotation
	// order.
	// * All values are given as a percentage of the maximum bending angles (in
	// degrees),
	// * vertical speed (in millimeters per second) and angular speed (in
	// degrees per second).
	// */
	// void ardrone_at_set_progress_cmd( int32_t flag, float32_t phi, float32_t
	// theta, float32_t gaz, float32_t yaw );
	//
	//
	// /*****************************************************************
	// * AT CONFIG FUNCTIONS
	...
	// #define ARDRONE_CONFIG_KEY_IMM(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK)
	// #define ARDRONE_CONFIG_KEY_REF(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK)
	// #define ARDRONE_CONFIG_KEY_STR(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK)
	...
	// #undef ARDRONE_CONFIG_KEY_STR
	// #define ARDRONE_CONFIG_KEY_IMM(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK) ARDRONE_CONFIGURATION_PROTOTYPE(C_TYPE,NAME);
	// #define ARDRONE_CONFIG_KEY_REF(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK)
	// #define ARDRONE_CONFIG_KEY_STR(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK) ARDRONE_CONFIGURATION_PROTOTYPE(C_TYPE_PTR,NAME);
	// #include <config_keys.h> // must be included before to have types
	//
	// /********************************************************************
	// * CONFIG FUNCTIONS
	...
	// #undef ARDRONE_CONFIG_KEY_STR
	// #define ARDRONE_CONFIG_KEY_IMM(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK) C_TYPE NAME;
	// #define ARDRONE_CONFIG_KEY_REF(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK) C_TYPE NAME;
	// #define ARDRONE_CONFIG_KEY_STR(KEY, NAME, INI_TYPE, C_TYPE, C_TYPE_PTR,
	// RW, DEFAULT, CALLBACK) C_TYPE NAME;
